...
UPDATE run_events
SET idempotency_key = 'migrated-run-event:' || id::text
...
SELECT
    project_name, run_id, trace_id, span_id,
    last_trace_segment_id, last_row_index, last_event_type,
    last_event_time_unix_nano, last_run_event_id
FROM run_heads
ON CONFLICT (project_name, trace_id, span_id) DO NOTHING;
...
SELECT
    project_name, trace_id, span_id, last_trace_segment_id, last_row_index,
